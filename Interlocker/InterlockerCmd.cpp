...
public:
	virtual MStatus doIt(const MArgList& args)
	{
		...
		if (nameVal == "Console Table") {
			...
			string consoletable = "createNode transform -n Interlocker1; createNode mesh - n InterlockerShape1 - p Interlocker1;sets - add initialShadingGroup InterlockerShape1;createNode InterlockerNode - n InterlockerNode1;connectAttr time1.outTime InterlockerNode1.time;connectAttr InterlockerNode1.outputMesh InterlockerShape1.inMesh; ";
			commands += consoletable.c_str();
		}
